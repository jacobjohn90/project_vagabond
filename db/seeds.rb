...
Post.create(User_id: 1, City_id:1,:comment=>'Just left from a really important build over there, an its an really great place to move!', :title=>'love this town'),
Post.create(User_id: 1, City_id:1,:comment=>'Theres a lot of projects going on!',:title=>'So much fun!'),

Post.create(User_id: 2, City_id:2,:comment=>'WOW,ThEREs ALSORTS Of COOL STUFF TO SEE AND EXPLORe',:title=>'Blue skidoo we can too'),
Post.create(User_id: 2, City_id:2,:comment=>'There are paw prints EVERYWHERE',:title=>'Where is blue?!'),
Post.create(User_id: 2, City_id:2,:comment=>'Our frind Sally is from here! Lets see what she did today!',:title=>'ITS THE MAIL!'),

Post.create(User_id: 3, City_id:3,:comment=>'A Woman To raise At a Young age No help From him But she is alive To be Made strong', :title=>'Shes alive'),
Post.create(User_id: 3, City_id:3,:comment=>'Many a day has passed, the night has gone by, But still I find the time to put that bump off in your eye', :title=>'Hold on now!'),
